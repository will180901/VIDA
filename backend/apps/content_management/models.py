...
class ClinicSetting(models.Model):
    ...
    fee_general = models.DecimalField(max_digits=10, decimal_places=0, default=15000)
    fee_specialized = models.DecimalField(max_digits=10, decimal_places=0, default=25000)
