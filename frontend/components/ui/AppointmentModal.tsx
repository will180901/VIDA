...
const appointmentSchema = z.object({
  ...
  consultationType: z.enum(['generale', 'specialisee']),
            ...
            <div className="flex-1 overflow-y-auto p-4 scrollbar-hide">
              ...
              {currentStep === 2 && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <label className={`relative flex items-center gap-3 p-3 border rounded-md cursor-pointer transition-all ${
                      formData.consultationType === 'generale' 
                      ...
                      />
                      <div className="flex-1">
                        <p className="text-xs font-medium text-gray-900">Consultation générale</p>
                        <p className="text-[10px] text-gray-500">15 000 FCFA</p>
                      </div>
                    </label>
                    <label className={`relative flex items-center gap-3 p-3 border rounded-md cursor-pointer transition-all ${
                      formData.consultationType === 'specialisee' 
                        ? 'border-vida-teal bg-vida-teal/5' 
                        : 'border-gray-200 bg-white hover:border-gray-300'
                    }`}>
                      <input
                      ...
                      />
                      <div className="flex-1">
                        <p className="text-xs font-medium text-gray-900">Consultation spécialisée</p>
                        <p className="text-[10px] text-gray-500">25 000 FCFA</p>
                      </div>
                    </label>
                  </div>
                </div>
