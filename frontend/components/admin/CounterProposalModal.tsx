...
import { X, Calendar, Clock, CheckCircle, XCircle, Loader2, AlertCircle, ArrowRight } from 'lucide-react';
    ...
    try {
      await updateAppointment.mutateAsync({
        ...
        data: {
          ...
          status: 'confirmed',
          notes_staff: 'Contre-proposition acceptée',
        },
      });
  ...
  const handleReject = async () => {
    ...
    try {
      await updateAppointment.mutateAsync({
        ...
        data: {
          status: 'confirmed',
          notes_staff: `Contre-proposition refusée : ${rejectionReason}`,
        },
      });
      showToast('Contre-proposition refusée', 'success');
      onSuccess();
      onClose();
    } catch (error: any) {
      showToast(extractErrorMessage(error, toastMessages.error.generic), 'error');
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className={`rounded-lg p-3 border col-span-2 ${
                  ...
                  <h4 className="text-xs font-semibold text-gray-900 mb-2 flex items-center gap-2">
                    <AlertCircle className={`h-3.5 w-3.5 ${validationError ? 'text-red-600' : 'text-purple-600'}`} />
                    Nouvelle date proposée par le patient
                  </h4>
                  <div className="space-y-1">
                    <div className={`flex items-center gap-2 text-xs font-medium ${
                      validationError ? 'text-red-800' : 'text-purple-800'
                    }`}>
                      <Calendar className="h-3.5 w-3.5" />
                    ...
                    {appointment.patient_message && (
                      <div className={`mt-2 pt-2 border-t ${
                        validationError ? 'border-red-200' : 'border-purple-200'
                      }`}>
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[10px] text-red-600 mt-1 italic">
                      Vous devez refuser cette contre-proposition et proposer une autre date au patient.
                    </p>
                  </div>
                </motion.div>
              )}
              ...
              {!selectedAction && (
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <p className="text-xs font-semibold text-gray-900">Accepter la contre-proposition</p>
                      <p className="text-[10px] text-gray-600">
                        {validationError ? 'Date invalide - impossible d\'accepter' : 'Appliquer la nouvelle date/heure'}
                      </p>
                    </div>
                  </button>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <p className="text-xs font-semibold text-gray-900">Refuser la contre-proposition</p>
              ...
              {selectedAction === 'accept' && (
                <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                  ...
                  <p className="text-xs text-gray-700 mb-4">
                    Le rendez-vous sera modifié avec la nouvelle date/heure proposée par le patient.
                  </p>
